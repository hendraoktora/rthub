...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '🚨 Tekan Tombol Panik Darurat (Kirim sinyal bahaya ke Satpam & RT)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Tandai alarm darurat selesai ditangani' }),
...
exports.AlertController = AlertController = __decorate([
    (0, swagger_1.ApiTags)('Alert & Panic Button Darurat (Keamanan Lingkungan)'),
